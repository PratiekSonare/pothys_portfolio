...
const CartProducts = () => {
  ...
  return (
    <div className='overflow-x-scroll md:hidden'>
      <div className=''>
        <div className="p-1 w-screen pr-4 md:w-full">
            ...
            <div className='flex flex-col'>
                        ...
                        <div className='flex-1 flex flex-row items-center justify-center scale-75 md:scale-100 gap-5 md:gap-5'>
                          ...
                          <div className='flex flex-col gap-2 w-full'>
                            ...
                            <div className='flex flex-col'>
                              ...
                              <span className='self-end text2 text-xl md:text-lg text-black'>₹{(product.discount > 0 ? product.quantity * product.discounted_price : product.quantity * product.price).toFixed(2)}</span>
                            </div>
                          </div>
              ...
              <div className="flex justify-between">
                <div className='flex flex-col items-center justify-center'>
                  ...
                  <span className='text2 text-green-400 text-lg md:text-2xl'>₹(saved_price)!</span>
                </div>
