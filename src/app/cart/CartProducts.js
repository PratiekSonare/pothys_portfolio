...
const CartProducts = () => {
  ...
  return (
    ...
    <div className='hidden md:flex w-1/2 mt-10'>
      <div className="p-2 md:p-5 md:w-full bg-white border border-gray-400 rounded-lg shadow-lg">
        <div className='flex justify-between md:justify-between'>
          <h1 className="text-2xl font-bold mb-4 text3">Your Cart</h1>
          <button onClick={clearCart} className='flex p-2 gap-1 flex-row justify-center items-center rounded-lg h-[40px] bg-transparent border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white transition-colors duration-300 ease-in-out'>
            <Trash2 className='scale-90'/>
            <span className='text1'> Clear </span>
          </button>
        </div>
                        ...
                        <div className='grid grid-cols-[4fr_1fr_1fr_1fr] md:grid-cols-[2fr_1fr_1fr_1fr] items-center gap-5 md:gap-5'>
                          ...
                          <div className='flex flex-col'>
                            ...
                            <span className='self-end text2 text-[15px] md:text-lg text-black tracking-tighter'>
                              {product.numOrder} x {product.quantityType}
                            </span>
                          </div>
                          <div>
              ...
              <div className='flex flex-col items-center justify-center'>
                {saved_total > 0 ?
                  <div className='flex flex-col text-center'>
                    ...
                    <span className='text2 text-gray-600 text-lg md:text-2xl'><span className='md:text-3xl text-lg text-green-400'>₹{saved_total} </span>!</span>
                  </div>
                  :
                  <div className='flex flex-col text-center'>
                    ...
                    <button
                      onClick={() => router.push("/")} 
                      className='text2 text-green-400 bg-green-600 p-1 rounded-xl text-lg md:text-xl hover:bg-green-400 hover:text-green-600'>
                      Shop now!
                    </button>
                  </div>
