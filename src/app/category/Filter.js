    ...
    return (
        <>
            <div className='hidden md:flex md:flex-col gap-5'>
                <div className='bg-white px-5 py-5 rounded-lg card-sdw'>
                        ...
                        return (
                            <div key={index} className="mb-1">
                                <div className='flex flex-row gap-2 justify-start items-center group'>
                                    <div className={`text-gray-600 group-hover:text-red-500 ${isOpen ? 'text-red-500 text2' : 'text-gray-600'}`}>{category.logo}</div>
                                    <button
                                        className="flex flex-row items-center justify-center gap-5 relative w-fit"
                                        onClick={() => {
                                            if (hasSubcategories) {
                                    ...
                                    >
                                        ...
                                        <p className={`text0 text-base mt-1 cursor-pointer group ${isOpen ? 'text-red-500 text2' : 'text-gray-600'}`}>
                                            {categoryName}
                                            <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-red-300 transition-all duration-300 group-hover:w-full"></span>
                                        </p>
                                    </button>
                                </div>
                                ...
                                {isOpen && hasSubcategories && (
                                    <div className="ml-10 mt-1 flex flex-col gap-1 text1">
                                        {categoryMap[categoryName].map((sub, subIndex) => (
                                            <button
                                                ...
                                                className="text-sm text-gray-500 hover:text-blue-600 text-left"
                                            >
                                                {sub}
                                            </button>
                                        ))}
                ...
                <div className='bg-white px-10 py-5 rounded-lg card-sdw'>
                    <div className='flex flex-col gap-2'>
                        <p className='text3 text-2xl'>Filters</p>
